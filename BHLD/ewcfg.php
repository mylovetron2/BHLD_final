...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "projectBHLD"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'f5MH2VcCUqqsZu2c', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/projectBHLD.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{1DE41E66-CD1F-4379-A8DD-99D0FBA14385}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => "3306", "user" => "diavatly_ltd", "pass" => "cntt2019", "db" => "diavatly_ltd"]
	],
	...
	"ADMIN_PASSWORD" => "1234", // Administrator password
	...
	"UPLOAD_ALLOWED_FILE_EXT" => "gif,jpg,jpeg,bmp,png,doc,docx,xls,xlsx,pdf,zip,csv", // Allowed file extensions
