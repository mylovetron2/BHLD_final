 ...
 * Page class
 */
class bhld_ctctu_view extends bhld_ctctu
{
	...
	// Page object name
	public $PageObjName = "bhld_ctctu_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("mact") !== NULL) {
				...
				$returnUrl = "bhld_ctctulist.php"; // Return to list
			}
			if (Get("mavt") !== NULL) {
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "bhld_ctctulist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "bhld_ctctulist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
