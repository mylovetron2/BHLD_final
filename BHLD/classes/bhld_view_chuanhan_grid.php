 ...
 * Page class
 */
class bhld_view_chuanhan_grid extends bhld_view_chuanhan
{
	...
	// Page object name
	public $PageObjName = "bhld_view_chuanhan_grid";

	// Grid form hidden field names
	public $FormName = "fbhld_view_chuanhangrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'bhld_view_chuanhan'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_bhld_ctu();
