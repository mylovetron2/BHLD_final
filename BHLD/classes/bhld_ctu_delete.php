 ...
 * Page class
 */
class bhld_ctu_delete extends bhld_ctu
{
	...
	// Page object name
	public $PageObjName = "bhld_ctu_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("bhld_ctulist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("bhld_ctulist.php"); // Return to list
			}
		}
	}
