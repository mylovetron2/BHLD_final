 ...
 * Page class
 */
class bhld_view_chuanhan_edit extends bhld_view_chuanhan
{
	...
	// Page object name
	public $PageObjName = "bhld_view_chuanhan_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("bhld_view_chuanhanlist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "bhld_view_chuanhanlist.php")
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("bhld_view_chuanhanlist.php"), "", $this->TableVar, TRUE);
		$pageId = "edit";
