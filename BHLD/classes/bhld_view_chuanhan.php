...
/**
 * Table class for bhld_view_chuanhan
 */
class bhld_view_chuanhan extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'bhld_view_chuanhan';
		$this->TableName = 'bhld_view_chuanhan';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`bhld_view_chuanhan`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// mact
		$this->mact = new DbField('bhld_view_chuanhan', 'bhld_view_chuanhan', 'x_mact', 'mact', '`mact`', '`mact`', 200, 50, -1, FALSE, '`mact`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// mavt
		$this->mavt = new DbField('bhld_view_chuanhan', 'bhld_view_chuanhan', 'x_mavt', 'mavt', '`mavt`', '`mavt`', 3, 11, -1, FALSE, '`mavt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ngnhan
		$this->ngnhan = new DbField('bhld_view_chuanhan', 'bhld_view_chuanhan', 'x_ngnhan', 'ngnhan', '`ngnhan`', CastDateFieldForLike("`ngnhan`", 0, "DB"), 133, 10, 0, FALSE, '`ngnhan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ngnhantt
		$this->ngnhantt = new DbField('bhld_view_chuanhan', 'bhld_view_chuanhan', 'x_ngnhantt', 'ngnhantt', '`ngnhantt`', CastDateFieldForLike("`ngnhantt`", 0, "DB"), 133, 10, 0, FALSE, '`ngnhantt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sl
		$this->sl = new DbField('bhld_view_chuanhan', 'bhld_view_chuanhan', 'x_sl', 'sl', '`sl`', '`sl`', 3, 11, -1, FALSE, '`sl`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// dmtg
		$this->dmtg = new DbField('bhld_view_chuanhan', 'bhld_view_chuanhan', 'x_dmtg', 'dmtg', '`dmtg`', '`dmtg`', 3, 11, -1, FALSE, '`dmtg`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`bhld_view_chuanhan`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "bhld_view_chuanhanlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "bhld_view_chuanhanview.php")
			return $Language->phrase("View");
		elseif ($pageName == "bhld_view_chuanhanedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "bhld_view_chuanhanadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("bhld_view_chuanhanview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("bhld_view_chuanhanview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "bhld_view_chuanhanadd.php?" . $this->getUrlParm($parm);
		else
			$url = "bhld_view_chuanhanadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("bhld_view_chuanhanedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("bhld_view_chuanhanadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("bhld_view_chuanhandelete.php", $this->getUrlParm());
	}
