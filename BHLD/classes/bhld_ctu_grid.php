 ...
 * Page class
 */
class bhld_ctu_grid extends bhld_ctu
{
	...
	// Page object name
	public $PageObjName = "bhld_ctu_grid";

	// Grid form hidden field names
	public $FormName = "fbhld_ctugrid";
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_manv") && $CurrentForm->hasValue("o_manv") && $this->manv->CurrentValue != $this->manv->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_ngct") && $CurrentForm->hasValue("o_ngct") && $this->ngct->CurrentValue != $this->ngct->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_mapb") && $CurrentForm->hasValue("o_mapb") && $this->mapb->CurrentValue != $this->mapb->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_ghichu") && $CurrentForm->hasValue("o_ghichu") && $this->ghichu->CurrentValue != $this->ghichu->OldValue)
			return FALSE;
	...
	public function renderListOptions()
	{
		...
		if ($this->CurrentMode == "edit" && is_numeric($this->RowIndex) && $this->RowAction != "delete") {
			$this->MultiSelectKey .= "<input type=\"hidden\" name=\"" . $keyName . "\" id=\"" . $keyName . "\" value=\"" . $this->mact->CurrentValue . "\">";
		}
	...
	protected function loadFormValues()
	{
		...
		if ($CurrentForm->hasValue("o_ngct"))
			$this->ngct->setOldValue($CurrentForm->getValue("o_ngct"));
		...
		if ($CurrentForm->hasValue("o_ghichu"))
			$this->ghichu->setOldValue($CurrentForm->getValue("o_ghichu"));
