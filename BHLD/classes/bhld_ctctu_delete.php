 ...
 * Page class
 */
class bhld_ctctu_delete extends bhld_ctctu
{
	...
	// Page object name
	public $PageObjName = "bhld_ctctu_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("bhld_ctctulist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("bhld_ctctulist.php"); // Return to list
			}
		}
	}
