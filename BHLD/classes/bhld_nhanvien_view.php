 ...
 * Page class
 */
class bhld_nhanvien_view extends bhld_nhanvien
{
	...
	// Page object name
	public $PageObjName = "bhld_nhanvien_view";
	...
	public function __construct()
	{
		...
		$keyUrl = "";
		if (Get("manv") !== NULL) {
			$this->RecKey["manv"] = Get("manv");
			$keyUrl .= "&amp;manv=" . urlencode($this->RecKey["manv"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("manv") !== NULL) {
				...
				$this->RecKey["manv"] = $this->manv->QueryStringValue;
			} elseif (IsApi() && Key(0) !== NULL) {
				$this->manv->setQueryStringValue(Key(0));
				$this->RecKey["manv"] = $this->manv->QueryStringValue;
			} elseif (Post("manv") !== NULL) {
				$this->manv->setFormValue(Post("manv"));
				$this->RecKey["manv"] = $this->manv->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->manv->setFormValue(Route(2));
				$this->RecKey["manv"] = $this->manv->FormValue;
			} else {
				$returnUrl = "bhld_nhanvienlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "bhld_nhanvienlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "bhld_nhanvienlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
