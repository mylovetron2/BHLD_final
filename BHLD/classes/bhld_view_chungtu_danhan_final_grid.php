 ...
 * Page class
 */
class bhld_view_chungtu_danhan_final_grid extends bhld_view_chungtu_danhan_final
{
	...
	// Page object name
	public $PageObjName = "bhld_view_chungtu_danhan_final_grid";

	// Grid form hidden field names
	public $FormName = "fbhld_view_chungtu_danhan_finalgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function validateForm()
	{
		...
		if (!CheckEuroDate($this->ngnhantt->FormValue)) {
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// ngnhantt
			$this->ngnhantt->setDbValueDef($rsnew, UnFormatDateTime($this->ngnhantt->CurrentValue, 7), CurrentDate(), $this->ngnhantt->ReadOnly);
	...
	protected function addRow($rsold = NULL)
	{
		...
		if ($this->manv->getSessionValue() != "") {
			$rsnew['manv'] = $this->manv->getSessionValue();
		}
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "bhld_view_nhanvien") {
			$this->manv->Visible = FALSE;
			if ($GLOBALS["bhld_view_nhanvien"]->EventCancelled)
