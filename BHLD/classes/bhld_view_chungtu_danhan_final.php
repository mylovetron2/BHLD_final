...
/**
 * Table class for bhld_view_chungtu_danhan_final
 */
class bhld_view_chungtu_danhan_final extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'bhld_view_chungtu_danhan_final';
		$this->TableName = 'bhld_view_chungtu_danhan_final';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`bhld_view_chungtu_danhan_final`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// mact
		$this->mact = new DbField('bhld_view_chungtu_danhan_final', 'bhld_view_chungtu_danhan_final', 'x_mact', 'mact', '`mact`', '`mact`', 200, 50, -1, FALSE, '`mact`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// mavt
		$this->mavt = new DbField('bhld_view_chungtu_danhan_final', 'bhld_view_chungtu_danhan_final', 'x_mavt', 'mavt', '`mavt`', '`mavt`', 3, 11, -1, FALSE, '`mavt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ngnhan
		$this->ngnhan = new DbField('bhld_view_chungtu_danhan_final', 'bhld_view_chungtu_danhan_final', 'x_ngnhan', 'ngnhan', '`ngnhan`', CastDateFieldForLike("`ngnhan`", 7, "DB"), 133, 10, 7, FALSE, '`ngnhan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ngnhantt
		$this->ngnhantt = new DbField('bhld_view_chungtu_danhan_final', 'bhld_view_chungtu_danhan_final', 'x_ngnhantt', 'ngnhantt', '`ngnhantt`', CastDateFieldForLike("`ngnhantt`", 7, "DB"), 133, 10, 7, FALSE, '`ngnhantt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// dmtg
		$this->dmtg = new DbField('bhld_view_chungtu_danhan_final', 'bhld_view_chungtu_danhan_final', 'x_dmtg', 'dmtg', '`dmtg`', '`dmtg`', 3, 11, -1, FALSE, '`dmtg`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// manv
		$this->manv = new DbField('bhld_view_chungtu_danhan_final', 'bhld_view_chungtu_danhan_final', 'x_manv', 'manv', '`manv`', '`manv`', 3, 11, -1, FALSE, '`manv`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->manv->IsForeignKey = TRUE; // Foreign key field
		...
		// mapb
		$this->mapb = new DbField('bhld_view_chungtu_danhan_final', 'bhld_view_chungtu_danhan_final', 'x_mapb', 'mapb', '`mapb`', '`mapb`', 200, 50, -1, FALSE, '`mapb`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// sl
		$this->sl = new DbField('bhld_view_chungtu_danhan_final', 'bhld_view_chungtu_danhan_final', 'x_sl', 'sl', '`sl`', '`sl`', 3, 11, -1, FALSE, '`sl`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getMasterFilter()
	{
		...
		// Master filter
		$masterFilter = "";
		if ($this->getCurrentMasterTable() == "bhld_view_nhanvien") {
			if ($this->manv->getSessionValue() != "")
				$masterFilter .= "`manv`=" . QuotedValue($this->manv->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
		}
		return $masterFilter;
	...
	public function getDetailFilter()
	{
		...
		if ($this->getCurrentMasterTable() == "bhld_view_nhanvien") {
			if ($this->manv->getSessionValue() != "")
				$detailFilter .= "`manv`=" . QuotedValue($this->manv->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
		}
		return $detailFilter;
	...
	// Master filter
	public function sqlMasterFilter_bhld_view_nhanvien()
	{
		return "`manv`=@manv@";
	}

	// Detail filter
	public function sqlDetailFilter_bhld_view_nhanvien()
	{
		return "`manv`=@manv@";
	}
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`bhld_view_chungtu_danhan_final`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "bhld_view_chungtu_danhan_finallist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "bhld_view_chungtu_danhan_finalview.php")
			return $Language->phrase("View");
		elseif ($pageName == "bhld_view_chungtu_danhan_finaledit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "bhld_view_chungtu_danhan_finaladd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("bhld_view_chungtu_danhan_finalview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("bhld_view_chungtu_danhan_finalview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "bhld_view_chungtu_danhan_finaladd.php?" . $this->getUrlParm($parm);
		else
			$url = "bhld_view_chungtu_danhan_finaladd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("bhld_view_chungtu_danhan_finaledit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("bhld_view_chungtu_danhan_finaladd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("bhld_view_chungtu_danhan_finaldelete.php", $this->getUrlParm());
	}

	// Add master url
	public function addMasterUrl($url)
	{
		if ($this->getCurrentMasterTable() == "bhld_view_nhanvien" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
			$url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
			$url .= "&fk_manv=" . urlencode($this->manv->CurrentValue);
		}
		return $url;
	}
	...
	public function renderEditRow()
	{
		...
		if ($this->manv->getSessionValue() != "") {
			$this->manv->CurrentValue = $this->manv->getSessionValue();
			$this->manv->ViewValue = $this->manv->CurrentValue;
			$this->manv->ViewValue = FormatNumber($this->manv->ViewValue, 0, -2, -2, -2);
			$this->manv->ViewCustomAttributes = "";
		} else {
