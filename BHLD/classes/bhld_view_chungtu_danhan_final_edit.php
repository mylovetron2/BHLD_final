 ...
 * Page class
 */
class bhld_view_chungtu_danhan_final_edit extends bhld_view_chungtu_danhan_final
{
	...
	// Page object name
	public $PageObjName = "bhld_view_chungtu_danhan_final_edit";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canEdit()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("bhld_view_chungtu_danhan_finallist.php"));
				else
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("bhld_view_chungtu_danhan_finallist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "bhld_view_chungtu_danhan_finallist.php")
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("bhld_view_chungtu_danhan_finallist.php"), "", $this->TableVar, TRUE);
		$pageId = "edit";
