 ...
 * Page class
 */
class bhld_nhanvien_delete extends bhld_nhanvien
{
	...
	// Page object name
	public $PageObjName = "bhld_nhanvien_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("bhld_nhanvienlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("bhld_nhanvienlist.php"); // Return to list
			}
		}
	}
